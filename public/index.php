...
Router::get('/admin/edit_user',[UsersController::class,'editUser']);
Router::get('/admin/remove_user',[UsersController::class,'remove']);
Router::post('/admin/save_user',[UsersController::class,'store']);
Router::post('/admin/update_user',[UsersController::class,'update']);
#########################categories#######################
...
Router::get('/admin/edit_user_payment',[user_pay_MController::class,'edituser_payment']);
Router::get('/admin/remove_user_payment',[user_pay_MController::class,'remove']);
Router::post('/admin/save_user_payment',[user_pay_MController::class,'store']);
Router::post('/admin/update_user_payment',[user_pay_MController::class,'update']);
#########################authors#######################
...
Router::get('/admin/remove_author',[AuthorsController::class,'remove']);
...
Router::get('/admin/remove_publisher',[PublishersController::class,'remove']);
Router::post('/admin/save_publisher',[PublishersController::class,'store']);
Router::post('/admin/update_publisher',[PublishersController::class,'update']);
#########################books#######################
Router::get('/admin/books',[BooksController::class,'listAll']);
Router::get('/admin/add_book',[BooksController::class,'add_book']);
Router::get('/admin/edit_book',[BooksController::class,'editbook']);
Router::get('/admin/remove_book',[BooksController::class,'remove']);
Router::post('/admin/save_book',[BooksController::class,'store']);
Router::post('/admin/update_book',[BooksController::class,'update']);
#########################city#######################
...
Router::get('/admin/remove_city',[CityController::class,'remove']);
...
Router::get('/admin/remove_offer',[OfferController::class,'remove']);
...
Router::get('/admin/remove_payement',[payementController::class,'remove']);
...
Router::get('/admin/remove_role',[roleController::class,'remove']);
...
Router::get('/admin/remove_useraddress',[useraddressController::class,'remove']);
...
Router::get('/admin/remove_user_token',[useraddressController::class,'remove']);
...
Router::get('/admin/remove_user_profile',[user_profController::class,'remove']);

        ...
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0">
                  ...
                  <div class="dropdown-shortcuts-list scrollable-container">
                    ...
                    <div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                          <i class="bx bx-useraddress fs-4"></i>
                        </span>
                        <a href="app-useraddress-list.html" class="stretched-link">useraddress App</a>
                        <small class="text-muted mb-0">Manage useraddresss</small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                    ...
                    <div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
                        ...
                        <small class="text-muted mb-0">useraddress Profile</small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
              ...
              <!--/ Notification -->
              <!-- useraddress -->
              <li class="nav-item navbar-dropdown dropdown-useraddress dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item" href="pages-profile-useraddress.html">
                      <i class="bx bx-useraddress me-2"></i>
        ...
        <tbody>
         ...
         <?php foreach($params as $useraddress){?>
          <tr>
            ...
            <td>
            <a href="/admin/edit_useraddress/<?php echo $useraddress['id'];?>" class="btn btn-icon btn-outline-dribbble">

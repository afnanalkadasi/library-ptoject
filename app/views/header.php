<header class="header" >
                <nav class="navbar ">
                    <div class="header-1" id="nav_menu">
                        <ul class="nav_list">
                            <li class="nav_item" ><a href="/login" class="nav_link " ><img src="../svg/svgexport-1.svg" class="nav_icon"> أدخل لحسابك أو سجل الان </a></li>
                    ...
                    <div class="header-2">
                           ...
                           <div class="icon_shop">
                                    ...
                                    <a href="/sal"><img src="../svg/svgexport-50.svg" ></a>    
                                </div>
                    </div>
                </nav>
            </header>
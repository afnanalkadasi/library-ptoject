        ...
        <tbody>
         ...
         <?php foreach($params as $offer){?>
          <tr>
            ...
            <td><?= $offer['book_ids'];?></td>
            <td><?= $offer['category_ids'];?></td>
            <td><?= $offer['all_books'];?></td>
            ...
            <td>
            <a href="/admin/edit_offer/<?php echo $offer['id'];?>" class="btn btn-icon btn-outline-dribbble">

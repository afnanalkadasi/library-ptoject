        ...
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0">
                  ...
                  <div class="dropdown-shortcuts-list scrollable-container">
                    ...
                    <div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                          <i class="bx bx-user_payment fs-4"></i>
                        </span>
                        <a href="app-user_payment-list.html" class="stretched-link">user_payment App</a>
                        <small class="text-muted mb-0">Manage user_payments</small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                    ...
                    <div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
                        ...
                        <small class="text-muted mb-0">user_payment Profile</small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
              ...
              <!--/ Notification -->
              <!-- user_payment -->
              <li class="nav-item navbar-dropdown dropdown-user_payment dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item" href="pages-profile-user_payment.html">
                      <i class="bx bx-user_payment me-2"></i>
        ...
        <tbody>
         ...
         <?php foreach($params as $user_payment){?>
          <tr>
            ...
            <td>
            <a href="/admin/edit_user_payment/<?php echo $user_payment['id'];?>" class="btn btn-icon btn-outline-dribbble">
                <i class="tf-icons bx bx-edit-alt me-1"></i>
              </a>
              <form action="/admin/remove_user_payment/<?=  $user_payment['id']; ?>" method="POST" style="display: inline-block;">
